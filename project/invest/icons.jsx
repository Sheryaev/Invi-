/* Line icons (HeroUI-style, 24px stroke). Usage: <Icon name="wallet" size={18} /> */
const ICON_PATHS = {
  ...
  layers: <><path d="M12 3 3 8l9 5 9-5-9-5Z"/><path d="M3 13l9 5 9-5M3 18l9 5 9-5" opacity="1"/></>,
...
/* filled mini triangles for deltas */
function Tri({ up, size = 9, color }) {
  return (
    <svg width={size} height={size} viewBox="0 0 10 10" style={{ flexShrink: 0 }}>
      <path d={up ? "M5 1 9 8 1 8Z" : "M5 9 1 2 9 2Z"} fill={color || "currentColor"} />
    </svg>
  );
}
window.Tri = Tri;
